...
<table id="table_content">
	...
	<tr class="board_tr">
		...
		<td class="btn_delete"><a href="proc_table_find_delete.jsp?bnum=<%=bnum %>"><button class="board_btn">삭제</button></a></td>
		<td colspan=2 class="btn_update"><a href="table_find_update.jsp?bnum=<%=bnum %>"><button class="board_btn">수정</button></a></td>
		<% } 
		else{%>
		<%} %>
	</tr>
...
<form action="table_find_comment_write.jsp" name="frm" method="post">
	...
	<% String write_id = (cookie_id != null) ? cookie_id : "익명"; %>
		...
		<td style="text-align:right"><input type="hidden" name="bnum" value="<%= bnum %>">
